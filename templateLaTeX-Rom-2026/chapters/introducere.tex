...
Tema este delimitată la un instrument desktop de adnotare, care integrează metode semi-automate prin apelarea unor modele externe. Modelul nu este antrenat în cadrul lucrării, ci este folosit ca suport pentru propunerea contururilor. Pentru măști și segmentare asistată este folosit un model de tip Mask2Former, iar pentru pre-adnotare prin detecții și contururi/poligoane se folosește un model de tip YOLOE.
