...
Componenta de inteligență artificială este integrată prin AutoSeg și AutoMask, care rulează modele externe ca subprocessuri asincrone. Rezultatele sunt transformate în adnotări editabile, iar utilizatorul le poate corecta imediat. Astfel, aplicația combină propunerea automată cu controlul manual, obținând un echilibru între viteză și acuratețe.
