...
\begin{itemize}
	...
	\item \textbf{Integrare AI (Artificial Intelligence) semi-automată.} Folosirea AutoSeg pentru propuneri de detecție și contur.
	AutoMask este folosit pentru măști care pot fi corectate imediat de utilizator. Scopul este accelerarea procesului fără a compromite calitatea adnotărilor.
...
\hline
AI semi-automată & AutoSeg pentru box-uri/contururi;
AutoMask pentru măști, toate corectabile imediat. \\
\hline
