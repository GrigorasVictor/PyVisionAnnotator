...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\centering\arraybackslash}p{0.07\textwidth}|p{0.36\textwidth}|>{\centering\arraybackslash}p{0.07\textwidth}|p{0.36\textwidth}|}
        ...
        \hline
        1 & Câmpul \texttt{Next Label}, folosit pentru eticheta implicită a următoarei adnotări create.
        & 10 & Unealta \texttt{Eraser}, folosită pentru ștergerea locală a zonelor dintr-o mască. \\
        \hline
        2 & Controlul \texttt{Next Color}, format din mostra de culoare și butonul pentru alegerea culorii implicite.
        & 11 & Lista \texttt{Annotations}, care afișează adnotările existente, identificatorul, eticheta și coordonatele lor. \\
        \hline
        3 & Sliderul \texttt{Mask Opacity}, care controlează transparența măștilor afișate peste imagine.
        & 12 & Butonul \texttt{Delete Selected}, care șterge adnotarea selectată. \\
        \hline
        4 & Lista \texttt{Existing Labels}, unde sunt afișate etichetele deja folosite și numărul aparițiilor lor.
        & 13 & Butonul \texttt{Delete All}, care șterge toate adnotările asociate imaginii curente. \\
        \hline
        5 & Unealta \texttt{Rect}, utilizată pentru desenarea dreptunghiurilor de încadrare.
        & 14 & Sliderul \texttt{Brightness}, folosit pentru ajustarea luminozității imaginii afișate. \\
        \hline
        6 & Butonul \texttt{AutoSeg}, care rulează segmentarea automată YOLO pe imaginea curentă.
        & 15 & Sliderul \texttt{Contrast}, folosit pentru ajustarea contrastului imaginii afișate. \\
        \hline
        7 & Unealta \texttt{Poly}, utilizată pentru desenarea adnotărilor de tip poligon.
        & 16 & Sliderul \texttt{Gamma}, folosit pentru corecția gamma a imaginii afișate. \\
        \hline
        8 & Unealta \texttt{Brush}, folosită pentru extinderea sau corectarea manuală a unei măști selectate.
        & 17 & Butonul \texttt{Reset}, care readuce ajustările vizuale ale imaginii la valorile implicite. \\
        \hline
        9 & Unealta \texttt{AutoMask}, care generează o mască pe baza unui punct ales de utilizator în canvas.
        & 18 & Opțiunea \texttt{Crosshair}, care activează sau dezactivează ghidajul vizual al cursorului pe canvas. \\
        \hline
    \end{tabular}
