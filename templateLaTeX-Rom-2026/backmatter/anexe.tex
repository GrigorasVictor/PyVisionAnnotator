...
\begin{table}[!htbp]
    ...
    \begin{tabular}{|p{0.78\textwidth}|p{0.12\textwidth}|}
        ...
        \hline
        \hyperref[fig:exemplu-export-json-masca]{Figura~\ref*{fig:exemplu-export-json-masca} -- Exemplu de export al unei adnotări de tip mască în format JSON intern} &
        \pageref{fig:exemplu-export-json-masca} \\
        \hline
