...
public class UserService extends AbstractService<User, UserRepository> {
    ...
    private void publishRegisterEvent(User user) {
        try {
            ...
            rabbitTemplate.convertAndSend(authEventsExchange, userRegisterRoutingKey, payload);
        } catch (Exception e) {
            logger.warn("User created but register event was not published for {}", user.getEmail(), e);
        }
    }
